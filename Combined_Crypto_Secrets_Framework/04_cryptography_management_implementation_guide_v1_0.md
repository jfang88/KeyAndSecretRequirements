...
**Review Cycle:** Annual  
**Companion Standards:** Secrets, Keys, and Cryptography Technical Standards v1.1
...
**Reference:** Secrets, Keys, and Cryptography Technical Standards v1.1 (Standards Doc #2) for lifecycle requirements, approved profiles, and control IDs.
...
1. Secrets, Keys, and Cryptography Policy v1.1
2. Secrets, Keys, and Cryptography Technical Standards v1.3
3. Huawei Cloud KMS documentation
4. AWS KMS documentation
5. VMware vHSM / PKCS#11 integration documentation
6. AWS CloudHSM or dedicated HSM platform documentation
7. Applicable Cap. 653 and SFC control obligations
