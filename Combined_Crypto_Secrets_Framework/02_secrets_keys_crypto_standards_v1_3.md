# Secrets, Keys, and Cryptography Technical Standards v1.3
...
# Appendix A. Implementation profiles (relocated)

Detailed platform examples, deployment profiles, and Kubernetes delivery patterns formerly included here have been relocated to the Secrets Management Implementation Guide so that implementation-specific material lives with operational procedures. The normative control requirements remain in this standards document.
...
5. NIST SP 800-57, NIST SP 800-63, and NIST SP 800-131A
6. CSA Cloud Controls Matrix (CCM) and related implementation guidance
7. Secrets, Keys, and Cryptography Policy v1.1
8. Secrets Management Implementation Guide v1.1
9. Cryptography Management Implementation Guide v1.0
