...
**Reference:** Secrets, Keys, and Cryptography Technical Standards v1.1 (Standards Doc #2) for lifecycle requirements, inventory schemas, and control IDs.
...
3. Huawei Cloud CSMS / DEW documentation
4. AWS Secrets Manager documentation
5. HashiCorp Vault documentation
6. Kubernetes Secrets Store CSI Driver documentation
