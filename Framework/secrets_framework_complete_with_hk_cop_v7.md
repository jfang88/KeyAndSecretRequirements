...
All placeholder tool-style citations were removed from the document body, and the document now contains 26 clickable external HTTPS links in the reference sections and inline R-code citations.
